...
```shell
sh -c "$(curl -fsSL https://raw.githubusercontent.com/ecl66/ohmyzsh/master/tools/install.sh)"
```

#### via wget

```shell
sh -c "$(wget -O- https://raw.githubusercontent.com/ecl66/ohmyzsh/master/tools/install.sh)"
```
